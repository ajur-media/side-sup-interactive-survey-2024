    ...
    data: (
      <div className={styles["block"]}>
        <div className={styles["block-buttons"]}>
          ...
          <CustomButton onClick={() => setState("answer1")}>
            Ma chérie, мое самое авантюрное желание &mdash; искупаться в лучах
      ...
      <div className={styles["block"]}>
        <div className={styles["block-buttons"]}>
          ...
          <CustomButton onClick={() => setState("answer32")}>
            Вы не видите, что я могу дать вам вселенскую любовь. Танец &mdash;
            всего лишь временное искусство, а я превращу вашу жизнь в вечную
