...
const bigLabels = [
  [59.95761, 30.288491, "Петроградский район"],
  ...
  [59.96094, 30.343865, "Выборгский район"],
];
...
const bigLabelsLayerGroup = L.layerGroup(
  bigLabels.map((label) => getMarker(...label)),
);

export default bigLabelsLayerGroup;
